...
5. Add holdout evaluation for realistic, interview-safe reporting.
...
- Holdout fraud metrics (time split, selected threshold):
  - Recall: `83.5%`
  - Precision: `100.0%`
  - False positives: `0`
  - Context: threshold-specific holdout sample result on project data.

## Business Meaning (Non-Technical)
...
## Communication Rules for Resume/Interviews

- Prefer: "identified", "quantified", "estimated", "opportunity".
